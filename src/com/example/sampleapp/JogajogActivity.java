...
public class JogajogActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        WebView webView = (WebView) findViewById(R.id.jogajogWebView);
        String customHtml = makinglist("JogajogInformation");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.jogajog, menu);
		return true;
	}
